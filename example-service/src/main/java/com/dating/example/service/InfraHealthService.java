...
import com.dating.example.health.MinioInfraHealthChecker;
import com.dating.example.health.NacosInfraHealthChecker;
import com.dating.example.health.PostgresInfraHealthChecker;
import com.dating.example.health.RedisInfraHealthChecker;
...
public class InfraHealthService {
    ...
    public Map<String, Object> checkAll() {
        ...
        body.put("service", "example-service");
        body.put("stage", "00-B");
